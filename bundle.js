!function() {
    ...
    class U {
        ...
        set downMode(t) {
            ...
            r = (this._oldPivotY - e.pivotY) * e.scaleY,
    ...
    class G extends Laya.Button {
        constructor() {
            ...
            this._reversed = !1,
            this._reverseDirection = G.REVERSE_HORIZONTAL,
        ...
        updateEffect() {
            if (this._effect)
                if (this._effectOn) {
                    ...
                    e == G.LAYER_TOP ? this.addChild(t) : e == G.LAYER_BOTTOM && this.addChildAt(t, 0)),
                    t.autoPlay = !0,
        ...
        onMouse(t) {
            this.enableAnimating ? !1 === this.toggle && this._selected || (this._mouseClick || (this._mouseClick = U.create(this)),
    ...
    G.REVERSE_HORIZONTAL = "horizontal",
    G.REVERSE_VERTICAL = "vertical",
    G.LAYER_TOP = "top",
    G.LAYER_BOTTOM = "bottom";
        ...
        changeItems() {
            if (this.enable) {
                ...
                for (let e = 0, t = i.length; e < t; e++) {
                    ...
                    this._align == H.TOP ? t.y = 0 : this._align == H.MIDDLE ? t.y = .5 * (s - t.height * t.scaleY) : this._align == H.BOTTOM && (t.y = s - t.height * t.scaleY)
                }
    ...
    class Z extends Laya.UIComponent {
        constructor(e, t=0, i) {
            ...
            this.top = 0,
            this.centerX = 0,
            new G("cat/ui_comm/img_public_btn_back.png"));
            if (a.stateNum = 1,
            a.left = 7,
            a.centerY = 0,
            a.name = "Back",
    ...
    var t, e = j, i = Q, h = Laya.ClassUtils.regClass, r = t = t || {};
    r = (r = r.cat || (r.cat = {})).views || (r.views = {});
    {
        ...
        r.BuyItemDlgUI = Di,
        h("ui.cat.views.common.BuyItemDlgUI", Di);
        class Ii extends i {
            constructor() {
                super()
            }
        ...
        r.CommRewardDlgUI = Ii,
        h("ui.cat.views.common.CommRewardDlgUI", Ii);
        class Ri extends e {
            constructor() {
                super()
            }
        ...
        r.CountViewUI = Ri,
        h("ui.cat.views.common.CountViewUI", Ri);
        class Ti extends e {
            constructor() {
                super()
            }
        ...
        r.FingerViewUI = Ti,
        h("ui.cat.views.common.FingerViewUI", Ti);
        class Ei extends e {
            constructor() {
                super()
            }
        ...
        r.FishCoinViewUI = Ei,
        h("ui.cat.views.common.FishCoinViewUI", Ei);
        class Ai extends e {
            constructor() {
                super()
            }
        ...
        r.LoadingViewUI = Ai,
        h("ui.cat.views.common.LoadingViewUI", Ai);
        class Mi extends e {
            constructor() {
                super()
            }
        ...
        r.LvViewUI = Mi,
        h("ui.cat.views.common.LvViewUI", Mi);
        class Ni extends i {
            constructor() {
                super()
            }
        ...
        r.MsgBoxUI = Ni,
        h("ui.cat.views.common.MsgBoxUI", Ni);
        class Pi extends e {
            constructor() {
                super()
            }
        ...
        r.NewViewUI = Pi,
        h("ui.cat.views.common.NewViewUI", Pi);
        class Fi extends e {
            constructor() {
                super()
            }
        ...
        r.SystemNoticeUI = Fi,
        h("ui.cat.views.common.SystemNoticeUI", Fi);
        class Bi extends e {
            constructor() {
                super()
            }
        ...
        r.ToastViewUI = Bi,
        h("ui.cat.views.common.ToastViewUI", Bi);
        class Ui extends e {
            constructor() {
                super()
            }
        ...
        r.WifiViewUI = Ui,
        h("ui.cat.views.common.WifiViewUI", Ui)
    }
    r = t = t || {};
    r = (r = r.cat || (r.cat = {})).views || (r.views = {});
    {
        ...
        r.GameEntranceUI = Gi,
        h("ui.cat.views.entrance.GameEntranceUI", Gi)
    }
    r = t = t || {};
    r = (r = r.cat || (r.cat = {})).views || (r.views = {});
    {
        ...
        r.FishAutoDlgUI = qi,
        h("ui.cat.views.fish.FishAutoDlgUI", qi);
        class Oi extends i {
            constructor() {
                super()
            }
        ...
        r.FishDlgUI = Oi,
        h("ui.cat.views.fish.FishDlgUI", Oi);
        class Hi extends e {
            constructor() {
                super()
            }
        ...
        r.FishHistoryCellViewUI = Hi,
        h("ui.cat.views.fish.FishHistoryCellViewUI", Hi);
        class Wi extends e {
            constructor() {
                super()
            }
        ...
        r.FishItemViewUI = Wi,
        h("ui.cat.views.fish.FishItemViewUI", Wi);
        class Vi extends e {
            constructor() {
                super()
            }
        ...
        r.FishRankCellViewUI = Vi,
        h("ui.cat.views.fish.FishRankCellViewUI", Vi);
        class Yi extends i {
            constructor() {
                super()
            }
        ...
        r.FishRankDlgUI = Yi,
        h("ui.cat.views.fish.FishRankDlgUI", Yi);
        class Xi extends e {
            constructor() {
                super()
            }
        ...
        r.FishRewardDetailCellViewUI = Xi,
        h("ui.cat.views.fish.FishRewardDetailCellViewUI", Xi);
        class zi extends i {
            constructor() {
                super()
            }
        ...
        r.FishRewardDetailDlgUI = zi,
        h("ui.cat.views.fish.FishRewardDetailDlgUI", zi);
        class ji extends i {
            constructor() {
                super()
            }
        ...
        r.FishRewardDlgUI = ji,
        h("ui.cat.views.fish.FishRewardDlgUI", ji);
        class $i extends i {
            constructor() {
                super()
            }
        ...
        r.FishRewardRuleDlgUI = $i,
        h("ui.cat.views.fish.FishRewardRuleDlgUI", $i);
        class Ki extends i {
            constructor() {
                super()
            }
        ...
        r.FishRuleDlgUI = Ki,
        h("ui.cat.views.fish.FishRuleDlgUI", Ki);
        class Ji extends i {
            constructor() {
                super()
            }
        ...
        r.FishSuccDlgUI = Ji,
        h("ui.cat.views.fish.FishSuccDlgUI", Ji);
        class Zi extends i {
            constructor() {
                super()
            }
        ...
        r.FishUpgradeDlgUI = Zi,
        h("ui.cat.views.fish.FishUpgradeDlgUI", Zi)
    }
    r = t = t || {};
    r = (r = r.cat || (r.cat = {})).views || (r.views = {});
    {
        ...
        r.AutoDlgUI = Qi,
        h("ui.cat.views.home.AutoDlgUI", Qi);
        class ts extends i {
            constructor() {
                super()
            }
        ...
        r.ChooseWalletDlgUI = ts,
        h("ui.cat.views.home.ChooseWalletDlgUI", ts);
        class es extends i {
            constructor() {
                super()
            }
        ...
        r.FirstRechargeDlgUI = es,
        h("ui.cat.views.home.FirstRechargeDlgUI", es);
        class is extends i {
            constructor() {
                super()
            }
        ...
        r.OffLineDlgUI = is,
        h("ui.cat.views.home.OffLineDlgUI", is);
        class ss extends i {
            constructor() {
                super()
            }
        ...
        r.OfficeDlgUI = ss,
        h("ui.cat.views.home.OfficeDlgUI", ss);
        class as extends i {
            constructor() {
                super()
            }
        ...
        r.PurchaseMethodDlgUI = as,
        h("ui.cat.views.home.PurchaseMethodDlgUI", as);
        class ns extends i {
            constructor() {
                super()
            }
        ...
        r.RandomEventsDlgUI = ns,
        h("ui.cat.views.home.RandomEventsDlgUI", ns);
        class os extends e {
            constructor() {
                super()
            }
        ...
        r.ShopCellViewUI = os,
        h("ui.cat.views.home.ShopCellViewUI", os);
        class hs extends i {
            constructor() {
                super()
            }
        ...
        r.ShopDlgUI = hs,
        h("ui.cat.views.home.ShopDlgUI", hs);
        class rs extends i {
            constructor() {
                super()
            }
        ...
        r.SpeedDlgUI = rs,
        h("ui.cat.views.home.SpeedDlgUI", rs);
        class ls extends e {
            constructor() {
                super()
            }
        ...
        r.SumCatViewUI = ls,
        h("ui.cat.views.home.SumCatViewUI", ls);
        class cs extends i {
            constructor() {
                super()
            }
        ...
        r.UpGradeDlgUI = cs,
        h("ui.cat.views.home.UpGradeDlgUI", cs)
    }
    r = t = t || {};
    r = (r = r.cat || (r.cat = {})).views || (r.views = {});
    {
        ...
        r.AssetCellViewUI = ms,
        h("ui.cat.views.lunchPool.AssetCellViewUI", ms);
        class ds extends i {
            constructor() {
                super()
            }
        ...
        r.AssetsDlgUI = ds,
        h("ui.cat.views.lunchPool.AssetsDlgUI", ds);
        class _s extends i {
            constructor() {
                super()
            }
        ...
        r.BoostMiningDlgUI = _s,
        h("ui.cat.views.lunchPool.BoostMiningDlgUI", _s);
        class us extends e {
            constructor() {
                super()
            }
        ...
        r.LunchCellViewUI = us,
        h("ui.cat.views.lunchPool.LunchCellViewUI", us);
        class gs extends e {
            constructor() {
                super()
            }
        ...
        r.LunchDetailViewUI = gs,
        h("ui.cat.views.lunchPool.LunchDetailViewUI", gs);
        class ps extends i {
            constructor() {
                super()
            }
        ...
        r.LunchDlgUI = ps,
        h("ui.cat.views.lunchPool.LunchDlgUI", ps);
        class Cs extends e {
            constructor() {
                super()
            }
        ...
        r.LunchInfoViewUI = Cs,
        h("ui.cat.views.lunchPool.LunchInfoViewUI", Cs);
        class ys extends i {
            constructor() {
                super()
            }
        ...
        r.LunchListDlgUI = ys,
        h("ui.cat.views.lunchPool.LunchListDlgUI", ys);
        class vs extends i {
            constructor() {
                super()
            }
        ...
        r.StakeCatBackDlgUI = vs,
        h("ui.cat.views.lunchPool.StakeCatBackDlgUI", vs);
        class fs extends i {
            constructor() {
                super()
            }
        ...
        r.StakeCatDlgUI = fs,
        h("ui.cat.views.lunchPool.StakeCatDlgUI", fs);
        class bs extends i {
            constructor() {
                super()
            }
        ...
        r.StakeFishBackDlgUI = bs,
        h("ui.cat.views.lunchPool.StakeFishBackDlgUI", bs);
        class ks extends i {
            constructor() {
                super()
            }
        ...
        r.StakeFishDlgUI = ks,
        h("ui.cat.views.lunchPool.StakeFishDlgUI", ks)
    }
    r = t = t || {};
    r = (r = r.cat || (r.cat = {})).views || (r.views = {});
    {
        ...
        r.RechargeCellViewUI = ws,
        h("ui.cat.views.recharge.RechargeCellViewUI", ws);
        class Ss extends i {
            constructor() {
                super()
            }
        ...
        r.RechargeDlgUI = Ss,
        h("ui.cat.views.recharge.RechargeDlgUI", Ss);
        class xs extends i {
            constructor() {
                super()
            }
        ...
        r.RechargeProcessingDlgUI = xs,
        h("ui.cat.views.recharge.RechargeProcessingDlgUI", xs);
        class Ls extends i {
            constructor() {
                super()
            }
        ...
        r.RechargeSuccessDlgUI = Ls,
        h("ui.cat.views.recharge.RechargeSuccessDlgUI", Ls)
    }
    r = t = t || {};
    r = (r = r.cat || (r.cat = {})).views || (r.views = {});
    {
        ...
        r.BoostCellViewUI = Ds,
        h("ui.cat.views.squad.BoostCellViewUI", Ds);
        class Is extends i {
            constructor() {
                super()
            }
        ...
        r.FrenZoneDlgUI = Is,
        h("ui.cat.views.squad.FrenZoneDlgUI", Is);
        class Rs extends e {
            constructor() {
                super()
            }
        ...
        r.FriendCellViewUI = Rs,
        h("ui.cat.views.squad.FriendCellViewUI", Rs);
        class Ts extends e {
            constructor() {
                super()
            }
        ...
        r.FriendInviteCellViewUI = Ts,
        h("ui.cat.views.squad.FriendInviteCellViewUI", Ts);
        class Es extends e {
            constructor() {
                super()
            }
        ...
        r.HeadViewUI = Es,
        h("ui.cat.views.squad.HeadViewUI", Es);
        class As extends i {
            constructor() {
                super()
            }
        ...
        r.InviteDetailShowDlgUI = As,
        h("ui.cat.views.squad.InviteDetailShowDlgUI", As);
        class Ms extends i {
            constructor() {
                super()
            }
        ...
        r.InvitePartyKingsDlgUI = Ms,
        h("ui.cat.views.squad.InvitePartyKingsDlgUI", Ms);
        class Ns extends i {
            constructor() {
                super()
            }
        ...
        r.JoinSquadListDlgUI = Ns,
        h("ui.cat.views.squad.JoinSquadListDlgUI", Ns);
        class Ps extends e {
            constructor() {
                super()
            }
        ...
        r.RankCellViewUI = Ps,
        h("ui.cat.views.squad.RankCellViewUI", Ps);
        class Fs extends i {
            constructor() {
                super()
            }
        ...
        r.SquadBoostDlgUI = Fs,
        h("ui.cat.views.squad.SquadBoostDlgUI", Fs);
        class Bs extends e {
            constructor() {
                super()
            }
        ...
        r.SquadCellViewUI = Bs,
        h("ui.cat.views.squad.SquadCellViewUI", Bs);
        class Us extends i {
            constructor() {
                super()
            }
        ...
        r.SquadInfoDlgUI = Us,
        h("ui.cat.views.squad.SquadInfoDlgUI", Us);
        class Gs extends i {
            constructor() {
                super()
            }
        ...
        r.SquadRankListDlgUI = Gs,
        h("ui.cat.views.squad.SquadRankListDlgUI", Gs);
        class qs extends i {
            constructor() {
                super()
            }
        ...
        r.TotalScoreDetailDlgUI = qs,
        h("ui.cat.views.squad.TotalScoreDetailDlgUI", qs);
        class Os extends i {
            constructor() {
                super()
            }
        ...
        r.TotalScoreShowDlgUI = Os,
        h("ui.cat.views.squad.TotalScoreShowDlgUI", Os)
    }
    class l {
    }
    l.GAME_LOCKED = "onGameLockChange",
    l.DATA_LOADED = "onDataLoaded",
    l.ENTER_GAME = "onEnterGame",
    l.NET_DISCONNECTED = "onNetDisconnected",
    l.NET_RECONNECTED = "onNetReconnected",
    l.NET_RESTARTGAME = "onNetRestartGame",
    l.NET_TYPE_CHANGE = "onNetTypeChanged",
    l.REENTER_GAME = "onReEnterGame",
    l.CLUB_UPDATE = "onClubUpdate",
    l.CREATE_VIEW_DONE = "onCreateViewDone",
    l.FISHCOIN_CHANGE = "onFishCoinChange",
    l.COUNT_CHANGE = "onCountChange",
    l.UPDATE_FISH_SYS = "onUpdateFishSys",
    l.DO_CONTINUE_FISH = "onDoContinueFish",
    l.FISHDATA_CHANGE = "onFishDataChange",
    l.MOVE_CAT = "onMoveCat",
    l.CAT_MATCH = "onCatMatch",
    l.SHAKE_CAT = "onShakeCat",
    l.UPDATE_CAT = "onUpdateCat",
    l.MaxCAT_CHANGE = "onMaxCatChange",
    l.UPDATE_ITEM = "onUpdateItem",
    l.BUY_CAT = "onBuyCat",
    l.UPDATE_SPEED = "onUpdateSpeed",
    l.UPDATE_OUTPUT = "onUpdateOutPut",
    l.UPDATE_OFFLINEGOLD = "onUpdateOffLineGold",
    l.HOME_GOLD_ANI = "onHomeGoldAni",
    l.OPNE_AIR_DROP = "onOpenAirDrop",
    l.AIR_DROP = "onAirDrop",
    l.RANDOM_EVENT_TIME_CHANGE = "onRandomEventTimeChange",
    l.WALLET_CONNECTED = "onWalletConnected",
    l.WALLET_DISCONNECT = "onWalletDisconnect",
    l.RECHARGE_SUCCESS = "onRechargeSuccess",
    l.SPEED_FREE = "onSpeedFree",
    l.UPDATE_LUNCH = "onUpdateLunch",
    l.POOLBONUS = "onPoolBonus";
    class tt {
        constructor(t=0) {
            this._delay = 0,
            this._queue = [],
    ...
    function ct(t, e, i) {
        ...
        -1 == t.name.indexOf("BattleView") && ut(),
        s.openView().then(()=>(gt(),
        s.pivotX = s.width / 2,
        s.pivotY = s.height / 2,
        s.showDialog(e, i),
    ...
    function mt(t) {
        ...
        t.toastImpl && (ht = t.toastImpl),
        t.verifyPwdImpl && (rt = t.verifyPwdImpl),
    ...
    Ct._sign = "p_PendingReqItem",
    (e = m = m || {})[e.NoneType = 0] = "NoneType",
    e[e.ErrorAck = 1] = "ErrorAck",
    e[e.ServerStateNtf = 4] = "ServerStateNtf",
    e[e.HeartBeatReq = 5] = "HeartBeatReq",
    e[e.HeartBeatAck = 6] = "HeartBeatAck",
    ...
    e[e.AccountInfoChangeNtf = 19] = "AccountInfoChangeNtf",
    e[e.MessageEventNtf = 20] = "MessageEventNtf",
    e[e.ItemChangeNtf = 26] = "ItemChangeNtf",
    e[e.GenerateCatReq = 27] = "GenerateCatReq",
    e[e.GenerateCatAck = 28] = "GenerateCatAck",
    e[e.MergeCatReq = 29] = "MergeCatReq",
    e[e.MergeCatAck = 30] = "MergeCatAck",
    e[e.GatherGoldReq = 31] = "GatherGoldReq",
    e[e.GatherGoldAck = 32] = "GatherGoldAck",
    e[e.DelCatReq = 33] = "DelCatReq",
    e[e.DelCatAck = 34] = "DelCatAck",
    e[e.SwitchPosCatReq = 35] = "SwitchPosCatReq",
    e[e.SwitchPosCatAck = 36] = "SwitchPosCatAck",
    e[e.BoostGoldReq = 37] = "BoostGoldReq",
    e[e.BoostGoldAck = 38] = "BoostGoldAck",
    e[e.GetOffLineGoldReq = 39] = "GetOffLineGoldReq",
    e[e.GetOffLineGoldAck = 40] = "GetOffLineGoldAck",
    e[e.GetAirDropCatReq = 41] = "GetAirDropCatReq",
    e[e.GetAirDropCatAck = 42] = "GetAirDropCatAck",
    e[e.BoostGoldNtf = 44] = "BoostGoldNtf",
    e[e.TokensInfoChangeNtf = 46] = "TokensInfoChangeNtf",
    e[e.GetFreeCatReq = 47] = "GetFreeCatReq",
    e[e.GetFreeCatAck = 48] = "GetFreeCatAck",
    e[e.RandomEventReq = 49] = "RandomEventReq",
    e[e.RandomEventAck = 50] = "RandomEventAck",
    e[e.GetRandomEventAwardReq = 51] = "GetRandomEventAwardReq",
    e[e.GetRandomEventAwardAck = 52] = "GetRandomEventAwardAck",
    e[e.GetRandomEventBoxReq = 53] = "GetRandomEventBoxReq",
    e[e.GetRandomEventBoxAck = 54] = "GetRandomEventBoxAck",
    e[e.MergeCatAutoReq = 55] = "MergeCatAutoReq",
    e[e.MergeCatAutoAck = 56] = "MergeCatAutoAck",
    e[e.RandomEventChangeNtf = 58] = "RandomEventChangeNtf",
    e[e.OffLineGoldNtf = 59] = "OffLineGoldNtf",
    ...
    e[e.JoinClubReq = 103] = "JoinClubReq",
    e[e.JoinClubAck = 104] = "JoinClubAck",
    e[e.GetRecruitClubListReq = 105] = "GetRecruitClubListReq",
    e[e.GetRecruitClubListAck = 106] = "GetRecruitClubListAck",
    e[e.QuitClubReq = 107] = "QuitClubReq",
    e[e.QuitClubAck = 108] = "QuitClubAck",
    e[e.ClubMemberRankReq = 109] = "ClubMemberRankReq",
    e[e.ClubMemberRankAck = 110] = "ClubMemberRankAck",
    e[e.GetStatsReq = 111] = "GetStatsReq",
    e[e.GetStatsAck = 112] = "GetStatsAck",
    e[e.GetGoldRankListReq = 113] = "GetGoldRankListReq",
    e[e.GetGoldRankListAck = 114] = "GetGoldRankListAck",
    e[e.ClubInfoReq = 115] = "ClubInfoReq",
    e[e.ClubInfoAck = 116] = "ClubInfoAck",
    e[e.FrensInfoReq = 117] = "FrensInfoReq",
    e[e.FrensInfoAck = 118] = "FrensInfoAck",
    e[e.InviteRankListReq = 119] = "InviteRankListReq",
    e[e.InviteRankListAck = 120] = "InviteRankListAck",
    e[e.GetClubGoldRankListReq = 121] = "GetClubGoldRankListReq",
    e[e.GetClubGoldRankListAck = 122] = "GetClubGoldRankListAck",
    e[e.GetMyRankReq = 123] = "GetMyRankReq",
    e[e.GetMyRankAck = 124] = "GetMyRankAck",
    e[e.GoldChangeNtf = 126] = "GoldChangeNtf",
    e[e.FrensInviterDoubleInfoReq = 127] = "FrensInviterDoubleInfoReq",
    e[e.FrensInviterDoubleInfoAck = 128] = "FrensInviterDoubleInfoAck",
    e[e.CreateClubReq = 157] = "CreateClubReq",
    e[e.CreateClubAck = 158] = "CreateClubAck",
    e[e.ClubGroupUserNameReq = 159] = "ClubGroupUserNameReq",
    e[e.ClubGroupUserNameAck = 160] = "ClubGroupUserNameAck",
    e[e.ClubInfoNtf = 188] = "ClubInfoNtf",
    e[e.GetWalletAddrReq = 201] = "GetWalletAddrReq",
    e[e.GetWalletAddrAck = 202] = "GetWalletAddrAck",
    ...
    e[e.GetFishRankRewardReq = 265] = "GetFishRankRewardReq",
    e[e.GetFishRankRewardAck = 266] = "GetFishRankRewardAck",
    e[e.FishHistoryReq = 267] = "FishHistoryReq",
    e[e.FishHistoryAck = 268] = "FishHistoryAck",
    e[e.FishRodUpReq = 269] = "FishRodUpReq",
    e[e.FishRodUpAck = 270] = "FishRodUpAck",
    e[e.GetLaunchListReq = 301] = "GetLaunchListReq",
    e[e.GetLaunchListAck = 302] = "GetLaunchListAck",
    e[e.LaunchStakeReq = 303] = "LaunchStakeReq",
    e[e.LaunchStakeAck = 304] = "LaunchStakeAck",
    e[e.RetrieveStakeReq = 305] = "RetrieveStakeReq",
    e[e.RetrieveStakeAck = 306] = "RetrieveStakeAck",
    e[e.ReceiveLaunchProfitReq = 307] = "ReceiveLaunchProfitReq",
    e[e.ReceiveLaunchProfitAck = 308] = "ReceiveLaunchProfitAck",
    e[e.LaunchPoolBonusNtf = 310] = "LaunchPoolBonusNtf",
    e[e.TonExchangeRateReq = 565] = "TonExchangeRateReq",
    e[e.TonExchangeRateAck = 566] = "TonExchangeRateAck",
    e[e.RequestPrePayReq = 567] = "RequestPrePayReq",
    e[e.RequestPrePayAck = 568] = "RequestPrePayAck",
    ...
    e[e.PayClubBoosterReq = 573] = "PayClubBoosterReq",
    e[e.PayClubBoosterAck = 574] = "PayClubBoosterAck",
    e[e.BCCheckInReq = 575] = "BCCheckInReq",
    e[e.BCCheckInAck = 576] = "BCCheckInAck",
    e[e.SysMsgNtf = 602] = "SysMsgNtf",
    e[e.WatchMsgReq = 603] = "WatchMsgReq",
    e[e.WatchMsgAck = 604] = "WatchMsgAck",
    e[e.UnWatchMsgReq = 605] = "UnWatchMsgReq",
    e[e.UnWatchMsgAck = 606] = "UnWatchMsgAck",
    e[e.ExDataNtf = 2062] = "ExDataNtf";
        ...
        sendAndWait(o, h, t, r) {
            return new Promise((i,s)=>{
                ...
                if (0 == n)
                    ...
                    e.open(i, s, Laya.Handler.create(this, this.clearPendingReq, [a]), r),
    ...
    class ft extends Laya.EventDispatcher {
        ...
        static create(t) {
            ...
            return null == t.noLoading && (t.noLoading = !0),
            t.noLoading || t.silent || !it.loadingImpl || (e._showLoadingItem = {
                finished: !1
            },
    ...
    function Ht(s, e, a, n, o, h) {
        ...
        for (let t = 0; t < e; t++) {
            ...
            let t = new Laya.Image
              , e = (h ? h.addChild(t) : dt(t, c.Effect),
            t.anchorX = t.anchorY = .5,
            t.scale(r[0], r[0]),
            t.skin = s,
            t.pos(a.x, a.y),
    ...
    (h = y = y || {})[h.None = 0] = "None",
    h[h.Recharge = 1] = "Recharge",
    h[h.ConnectWalletForBuyFishRecharge = 100] = "ConnectWalletForBuyFishRecharge",
    h[h.ConnectWalletForClubRecharge = 101] = "ConnectWalletForClubRecharge",
    h[h.ConnectWalletForSignInSpeed = 102] = "ConnectWalletForSignInSpeed",
    h[h.CheckOrderForSignInSpeed = 103] = "CheckOrderForSignInSpeed",
    h[h.ConnectWalletForFirstRecharge = 104] = "ConnectWalletForFirstRecharge",
    h[h.CheckOrderForFirstRecharge = 105] = "CheckOrderForFirstRecharge",
    (e = Gt = Gt || {})[e.signIn = 1] = "signIn",
    ...
    let S = new class {
        ...
        init(e) {
            ...
            this.wCati = e.wCati,
            this._icon = +e.icon,
            this.m_fishCoin = e.fishCoin,
            this.fishData = e.fishData,
            N.lunch.stakeCats = e.stakeCats,
            this.freeCd = +e.exData.speedFreeTime,
            this.boostEndTime = +e.boostEndTime,
            this.chainCd = +e.exData.SpeedChainTime,
            N.cat.initCat(e),
            this.exdata = e.exData || {},
            this.m_gold = e.gold || 0,
            this.bcId = e.bcId,
            this.rankGold = e.rankGold,
            this.randomEvent = e.randomEvent,
            ...
            window.Telegram) {
                ...
                if (e && e.start_param) {
                    let t = e.start_param;
                    var i, e = t.split("_");
                    "open" == e[0] && e[1] && (this.linkType = e[1],
                    e[1] == y.CheckOrderForSignInSpeed && (i = (new Date).getTime(),
                    w.set(w.s_signInSpeedOrderTime, i)),
                    e[1] == y.CheckOrderForFirstRecharge && (i = (new Date).getTime(),
        ...
        receiveRecharge(t) {
            ...
            return e.id = t,
            k(e, m.ReceiveRechargeReq, pb.IReceiveRechargeAck).then(t=>{
                this.addBuyedGoods(t.GoodsId);
                var e = +t.addFishCoin || 0
                  , i = (0 < e && (this.fishCoin = +t.FishCoin || 0,
                N.event(l.UPDATE_ITEM)),
                +t.addGold || 0);
                return i && (this.gold = +t.Gold || 0),
                e && N.event(l.RECHARGE_SUCCESS, [e, i]),
                t
            }
            )
        }
        ...
        getWalletAddress(t) {
            ...
            k(e, m.GetWalletAddrReq, pb.IGetWalletAddrAck).then(t=>t)
        }
        requestPrePay(t) {
            let e = pb.RequestPrePayReq.create();
            return e.id = t,
            k(e, m.RequestPrePayReq, pb.IRequestPrePayAck).then(t=>t)
        }
        requestPay(t, e=1) {
            let i = pb.RequestPayReq.create();
            return i.id = t,
            i.payType = e,
            k(i, m.RequestPayReq, pb.IRequestPayAck)
        }
        BCCheckIn(t) {
            let e = pb.BCCheckInReq.create();
            return e.checkInType = t,
            k(e, m.BCCheckInReq, pb.IBCCheckInAck)
        }
        payClubBooster(t, e, i=1) {
            ...
            s.amount = e,
            s.payType = i,
            k(s, m.PayClubBoosterReq, pb.IPayClubBoosterAck)
        }
        serverMessageEvent(t) {
            0 < t.retCode && g(Kt(t.retCode)),
            t.eventType && t.eventType == Lt.clubBooster && N.event(l.RECHARGE_SUCCESS)
        }
        getPurchaseGoods() {
            ...
            for (const n in Data.Recharges) {
                var i, s = Data.getRecharge(+n), a = s.id, s = s[t.name];
        ...
        reqRandomEvent() {
            return k(pb.RandomEventReq.create(), m.RandomEventReq, pb.IRandomEventAck).then(t=>{
                ...
                N.event(l.RANDOM_EVENT_TIME_CHANGE),
                N.event(l.UPDATE_SPEED)
            }
            )
        }
        reqGetRandomEventAward(t=At.close) {
            ...
            return e.opType = t,
            k(e, m.GetRandomEventAwardReq, pb.IGetRandomEventAwardAck).then(t=>{
                this.randomEvent = t.randomEventData,
        ...
        reqGetRandomEventBox() {
            ...
            return k(t, m.GetRandomEventBoxReq, pb.IGetRandomEventBoxAck, {
                ...
                for (let t = 0; t < e.cats.length; t++)
                    !s[t] && e.cats[t] && (N.cat.airDropMap[t] = 1,
                    N.cat.allcats[t] = e.cats[t],
        ...
        reqClubGroupUserName(t, e) {
            ...
            return i.clubId = e,
            i.groupUserId = t,
            k(i, m.ClubGroupUserNameReq, pb.IClubGroupUserNameAck).then(t=>t)
        }
        checkRandomBox() {
...
🎁Let's play-to-earn aridrop right now!`);
            Yt(`https://t.me/share/url?url=${t}&text=` + e),
            Laya.Browser.onAndroid && Xt()
        }
        doShareToTg(t, e) {
            zt(),
            Yt(`https://t.me/${Vt()}?start=sg_${t}_` + e),
            Xt()
        }
        doCreateClubAction() {
            zt(),
            Yt("https://t.me/" + Vt() + "?start=cc"),
            Xt()
        }
        toPremiumTg() {
            zt();
            Yt("https://t.me/premium"),
            Xt()
        }
        toSquadChat(t, e) {
            this.reqClubGroupUserName(t, e).then(t=>{
                zt(),
                Yt("https://t.me/" + t.groupUserName),
                Xt()
            }
            )
        }
        toTask() {
            Laya.Browser.onPC && zt(),
            Yt(`https://t.me/${Vt()}/webapp?startapp=open_1001_0`)
        }
    }
    ;
    ...
    class Zt {
        ...
        updateGold(t) {
            t.fishCoin && (S.fishCoin = +t.fishCoin),
    ...
    Mmobay.MConfig.showNetLog && (window.reqTest = function(t, e, i) {
        ...
        k(t, e, pb.IBindWalletAck).then(t=>{
            console.log(t)
        }
        )
    }
    ...
    class x {
        ...
        playMusic(t, e=0, i) {
            ...
            this._musicChannel && this._musicChannel.url.includes(t) ? this._musicChannel.isStopped && this._musicChannel.resume() : this._musicChannel = te.playMusic(t, e, i))
        }
        playSound(t, e=1, i) {
        ...
        stopSound(t) {
            ...
            te.stopSound(t)) : te.stopAllSound()
        }
        stopAll() {
            te.stopAll(),
            this._musicChannel = null
    ...
    class ee {
        ...
        reqOff(t) {
            ...
            return e.Type = t,
            k(e, m.GetOffLineGoldReq, pb.IGetOffLineGoldAck, {
                noLoading: !0
            }).then(t=>{
                S.m_gold = +t.gold,
                this.goldTime = t.goldTime,
                S.fishCoin = +t.fishCoin,
                S.offLine = null,
                N.event(l.HOME_GOLD_ANI)
            }
            )
        }
        reqSumCat(t) {
            ...
            return e.indexs = t,
            k(e, m.MergeCatReq, pb.IMergeCatAck, {
                noLoading: !0
            }).then(t=>{
                for (var e of t.cats)
                    if (e > this.getMyLv()) {
                        S.exdata.maxCatLvl = e,
                        N.event("updateShopRed"),
                        N.event(l.UPDATE_CAT),
                        N.event(l.MaxCAT_CHANGE);
                        break
                    }
                return N.event(l.UPDATE_OUTPUT),
                t.cats
            }
            )
        }
        reqSwitch(t) {
            ...
            return e.indexs = t,
            k(e, m.SwitchPosCatReq, pb.ISwitchPosCatAck, {
                noLoading: !0
            }).then(e=>{
                for (let t = 0; t < e.cats.length; t++)
                    this.allcats[t] = e.cats[t] || null;
                return N.event(l.UPDATE_CAT, [!0]),
                e
            }
            )
        }
        reqDelCat(t) {
            ...
            return e.indexs = [t],
            k(e, m.DelCatReq, pb.IDelCatAck, {
                noLoading: !0
            }).then(e=>{
                for (let t = 0; t < e.cats.length; t++)
                    this.allcats[t] = e.cats[t] || null;
                return N.event(l.UPDATE_CAT, [!0]),
                N.event(l.UPDATE_OUTPUT),
        ...
        reqSpeed(t) {
            ...
            return e.Type = t,
            k(e, m.BoostGoldReq, pb.IBoostGoldAck).then(t=>(S.boostEndTime = t.boostEndTime,
            S.exdata.speedFreeTime = t.SpeedFreeTime,
            S.fishCoin = +t.fishCoin,
            N.event(l.UPDATE_SPEED),
            N.event(l.UPDATE_ITEM),
        ...
        reqCreate(e=this.nowGenerateCat, t=!1, i=!1) {
            ...
            return s.lvl = e,
            s.Type = i ? 3 : t ? 2 : 1,
            k(s, m.GenerateCatReq, pb.IGenerateCatAck, {
                noLoading: !0
            }).then(t=>(S.m_gold = +t.gold,
            S.fishCoin = +t.fishCoin,
            this.allcats[t.index || 0] = t.catLvl,
            i && (this.freeCat = S.exdata.freeCatLvl = 0,
            N.event("updateShopRed")),
            S.exdata.catNumFish[e] = t.catNumFish,
            S.exdata.catNum[e] = t.catNum,
            N.event(l.UPDATE_CAT, [!0]),
            N.event(l.BUY_CAT, [t]),
            N.event(l.UPDATE_OUTPUT),
            N.event(l.UPDATE_ITEM),
        ...
        playCat(e, i, s="") {
            if (!e || e.skeleton && !e.destroyed) {
                ...
                e._templet && e._templet.once(Laya.Event.COMPLETE, this, ()=>{
                    let t = e.getAniIndexByName(i);
                    s.length ? e.play(t, !1, Laya.Handler.create(this, ()=>{
                        t = e.getAniIndexByName(i),
                        e.play(e.getAniIndexByName(s), !0)
        ...
        prepareCat(s, t, e) {
            let a = Data.getCat(t)
              ...
              , o = ""
              , h = (o = 200 <= +n ? "fat_" : 100 <= +n ? "chubby_" : "thin_",
        ...
        reqGetAirDropCat() {
            if (this.allcats.filter(t=>!t).length && !(this.checkNew() || S.randomEvent && S.randomEvent.boxNum))
                return k(new pb.GetAirDropCatReq, m.GetAirDropCatReq, pb.IGetAirDropCatAck, {
                    noLoading: !0
                }).then(e=>{
                    if (-1 != e.airdropIndex) {
        ...
        reqBuyAuto() {
            return k(new pb.MergeCatAutoReq, m.MergeCatAutoReq, pb.IMergeCatAutoAck, {
                ...
                S.exdata.autoMerge = t.autoMerge,
                N.event("buyAuto")
            }
            )
        }
    ...
    class ie {
        ...
        reqFishing(t) {
            ...
            return e.color = t,
            k(e, m.FishingReq, pb.IFishingAck).then(t=>(N.bag.updateItem(t.items),
            S.gold = +t.gold,
            S.fishCoin = +t.fishCoin,
            S.fishData = t.fishData,
            N.event(l.FISHDATA_CHANGE),
            t))
        }
        reqFishRodUp() {
            return k(pb.FishRodUpReq.create(), m.FishRodUpReq, pb.IFishRodUpAck).then(t=>(S.exdata.fishRobLvl = t.FishRodLvl,
            S.fishCoin = +t.fishCoin,
            t))
        }
        formatWeight(t) {
    ...
    let ae = new class {
        onErrorAck(t, e) {
            t.code == p.OtherLogined || t.code == p.BanAccount || t.code == p.BeKickoff ? N.login.handleErrorAck(t.code) : t.code == p.Maintain || t.code == p.AccessDenied ? N.login.handleMaintainErrorAck(t.code) : g(Kt(t.code))
        }
        ...
        onTokensInfoChangeNtf(t) {
            S.tokensInfoChange(t),
            N.lunch.reqLunchList().then(()=>{
                N.event("updateLunch")
            }
            )
        }
        ...
        onBoostGoldNtf(t) {
            S.exdata.SpeedChainTime = t.SpeedChainTime,
            S.boostEndTime = t.boostEndTime,
            S.exdata.speedFreeTime = t.SpeedFreeTime,
            N.event(l.UPDATE_SPEED)
        }
        onRandomEventChangeNtf(t) {
            S.randomEvent = t.randomEventData,
            N.event(l.RANDOM_EVENT_TIME_CHANGE),
            N.event(l.UPDATE_SPEED),
            S.checkRandomBox()
        }
        onOffLineGoldNtf(t) {
            S.offLine = +t.offGold && f(t.offGold),
            N.event(l.UPDATE_OFFLINEGOLD)
        }
    ...
    var ne = new class {
        ...
        checkLimit(t, e, i=!1) {
            return this._timeMap[t] ? (i && g("operating too frequently"),
            !1) : (this._timeMap[t] = !0,
    ...
    ;
    function oe(t, e=200, i=!1) {
        return ne.checkLimit(t, e, i)
    }
    function L(t, e, i, s) {
        ...
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
            ...
            for (var h = t.length - 1; 0 <= h; h--)
                (a = t[h]) && (o = (n < 3 ? a(o) : 3 < n ? a(e, i, o) : a(e, i)) || o);
    ...
    class he extends t.cat.views.fish.FishAutoDlgUI {
        onAwake() {
            super.onAwake(),
        ...
        updateView() {
            ...
            this.m_txt_Num.color = S.fishCoin >= t ? "#764428" : Jt.Red
        }
        onClickAuto() {
            this.closeDialog(this.m_view_Count.count ? o.Yes : o.No, [this.m_rad_Stop.selected, this.m_view_Count.count])
        }
    }
    L([D(l.COUNT_CHANGE)], he.prototype, "updateView", null);
    class re extends t.cat.views.fish.FishHistoryCellViewUI {
        dataChanged(t) {
            t ? this.dataSource = t : t = this.dataSource,
            Object.assign(this.m_div_Tip.style, {
                fontSize: 18,
                bold: !0,
                color: +t.param[1].val == Data.getFish(101).name ? Jt.Yellow : Jt.White,
                leading: 3,
                wordWrap: !0,
                width: 500
            }),
            ...
            this.m_div_Tip.innerHTML = N.sysNotice.parseSysMsg(t) + "",
            this.height = this.m_div_Tip.contextHeight + 4
        }
    }
    function le(n, e="D:HH:MM:ss") {
        n < 0 && (n = 0);
        let t = /D|([HhMs])\1?|S/
          , o = -1
          , h = -1
        ...
        -1 < (d = e.indexOf("&")) && ("" != m && (m += "|"),
        -1 == h ? m += e.slice(d, d + 1) : m += e.slice(h, d + 1)),
        -1 < (d = e.indexOf("@"))) {
            "" != m ? m += "|@" : m += "@";
            for (let t = 0; t < r.length; t++)
                0 == l[t] && (m = (m += "|") + e.slice(r[t], null == r[t + 1] ? d : r[t + 1]))
        }
        t = new RegExp(m,"g");
    ...
    class I {
        ...
        onTimerLoop() {
            ...
            e = Math.round(e / 1e3),
            "");
            if (i = null == this._format ? le(e) : le(e, this._format),
            this._timeLabel) {
    ...
    class ce extends t.cat.views.fish.FishRewardDetailDlgUI {
        constructor() {
            super(...arguments),
            this.m_sel = 0
        }
    ...
    class me extends t.cat.views.fish.FishRewardRuleDlgUI {
    }
    class de extends t.cat.views.fish.FishRankDlgUI {
        onAwake() {
            super.onAwake(),
        ...
        updateView(t) {
            this.tick && this.tick.dispose();
            let e = this.tick = I.create((i = Date.getMondayZeroTime().addDays(7).getTime(),
            ...
            if (this.m_txt_BonusNum.text) {
                if (this.m_oldPool != N.fish.m_fishPool) {
                    ...
                    this.tick_pool.onTick = ()=>{
                        8 < t ? (this.m_oldPool = N.fish.m_fishPool,
                        this.m_txt_BonusNum.text = f(N.fish.m_fishPool)) : this.m_txt_BonusNum.text = f(this.m_oldPool + e / 8 * t),
                        t++
                    }
                    ,
                ...
                this.m_txt_BonusNum.text = f(N.fish.m_fishPool)
        }
        onClickDetail() {
            _(ce)
        }
    ...
    class _e extends t.cat.views.fish.FishRuleDlgUI {
    }
    class ue extends t.cat.views.fish.FishSuccDlgUI {
        ...
        showUI() {
            ...
            var i, s = Data.getFish(e), a = (this.m_txt_Title.text = s && v(s.name),
            Data.getFishEvent(2)), n = a.goldMultiple[S.rankLeague] || 0, a = a.fishCoinMultiple || 0;
            ...
            this.m_txt_Total.text = f(N.cat.getBaseSpeed() * a * +i.multiple * n)) : this.m_isFomo ? (this.height = 810,
            this.m_img_GetFish.height = 190,
            this.m_box_Fomo.visible = !0,
            this.m_txt_Fomo.text = "x" + n,
            this.m_txt_Total.text = f(N.cat.getBaseSpeed() * a * n)) : i ? (this.height = 810,
            this.m_img_GetFish.height = 190,
            this.m_box_Rod.visible = !0,
            this.m_txt_Rod.text = "x" + f(i.multiple),
            this.m_txt_Total.text = f(a * N.cat.getBaseSpeed() * +i.multiple)) : (this.height = 730,
            this.m_img_GetFish.height = 100,
            this.m_box_Rod.visible = !1,
            this.m_txt_Total.text = f(a * N.cat.getBaseSpeed()))) : (124 == s.id ? (this.m_txt_TipsNoFish.text = v(1048),
            this.m_img_RightCoin.skin = "cat/ui_fish/earn2.png") : 125 == s.id && (this.m_txt_TipsNoFish.text = v(1047),
    ...
    class ge extends Laya.EventDispatcher {
        constructor() {
            super(...arguments),
            this._isLoading = !1,
            this._isLoaded = !1,
        ...
        static registerTimer() {
            Laya.timer.loop(3e4, null, ge.checkUnusedRes)
        }
        static checkUnusedRes() {
            if (ge._resRef.size) {
                var e, i, s = Date.newDate().getTime();
    ...
    class R extends Laya.Sprite {
        ...
        setData(t) {
            ...
            this._templet = ge.create(this._url),
            this._templet.once(Laya.Event.COMPLETE, this, this.onLoadComplete),
            this._templet.once(Laya.Event.ERROR, this, this.onLoadError),
    ...
    R._sign = "p_Spine";
    class pe extends t.cat.views.fish.FishRewardDlgUI {
        constructor(t, e) {
            super(),
            this.m_rank = e,
            this.m_data = t
        ...
        updateView() {
            this.m_txt_Desc.text = v(1037, this.m_rank),
            this.m_txt_BonusNum.text = f(this.m_data)
        }
    }
    class Ce extends t.cat.views.recharge.RechargeProcessingDlgUI {
        constructor() {
            super(...arguments),
            this.m_waitTimes = 30
        }
    ...
    L([D(l.RECHARGE_SUCCESS)], Ce.prototype, "onRechargeSuccess", null);
    class ye extends t.cat.views.home.ChooseWalletDlgUI {
        onClickMetamask(t) {
    ...
    class ve extends t.cat.views.home.PurchaseMethodDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
        ...
        connectWallet() {
            1 == this.m_data.type ? S.linkType = y.ConnectWalletForFirstRecharge : 2 == this.m_data.type ? S.linkType = y.ConnectWalletForBuyFishRecharge : 3 == this.m_data.type && (S.linkType = y.ConnectWalletForClubRecharge),
        ...
        sendTransaction() {
            ...
            Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE && Laya.Browser.onMobile ? _(ye, {
                showEffect: !1,
                retainPopup: !0
            }).then(t=>{
                t.wait().then(t=>{
                    t.type == o.Yes && (this.lockChainOperate(),
                    N.wallet.sendTransaction(e, i, s, Gt.recharge, t.data).then(()=>{
            ...
            N.wallet.sendTransaction(e, i, s, Gt.recharge).then(()=>{
                this.destroyed || this.closeDialog(o.Yes)
            }
            ).catch(t=>{
                this.unlockChainOperate(),
                t && 2 == t.code && g("Insufficient funds")
            }
            ))
        }
        playWait() {
    ...
    L([D(l.WALLET_CONNECTED), D(l.WALLET_DISCONNECT)], ve.prototype, "updateWallet", null),
    L([D(l.RECHARGE_SUCCESS)], ve.prototype, "onRechargeSuccess", null);
    ...
    class fe extends t.cat.views.fish.FishItemViewUI {
        constructor(t) {
            super(),
            this.m_data = null,
            this.m_tl = null,
        ...
        onAwake() {
            ...
            this.m_txt_Add.text = v(1048)) : 125 == t ? (this.m_img_Coin.skin = "",
            this.m_txt_Add.text = v(1047)) : 0 < +this.m_data.addFishCoin ? (this.m_txt_Add.text = "+" + f(this.m_data.addFishCoin),
    ...
    class be extends t.cat.views.fish.FishUpgradeDlgUI {
        onAwake() {
            super.onAwake(),
            this.showUI()
        }
        ...
        showUI() {
            ...
            this.m_txt_Tips.text = v(1049, e.catMaxLvl),
            this.m_txt_Next.text = "x" + f(e.multiple),
            this.m_txt_Cur.text = "x" + f(i && i.multiple || 0))
        }
        onClickUpgrade() {
    ...
    class ke extends t.cat.views.fish.FishDlgUI {
        constructor() {
            super(),
            this.m_tl = null,
            this.isAuto = !1,
        ...
        onDestroy() {
            ...
            N.sysNotice.reqUnWatch(Pt.fish)
        }
        onAwake() {
            super.onAwake(),
            this.addTitle(),
            ...
            this.showUI(),
            this.m_txt_Need.text = "/" + Data.gameConf.fishCfg.costCoin,
            N.sysNotice.reqFishHistory().then(t=>{
                for (let e of t.list)
                    u(re, {}).then(t=>{
        ...
        showFishBait() {
            var t = S.fishCoin;
            this.m_txt_Num.text = t + "",
            this.m_txt_Num.color = t >= +Data.gameConf.fishCfg.costCoin ? Jt.Green : Jt.Red
        }
        showFishAni() {
            var t;
            this.m_ygSpine || (t = S.exdata.fishRobLvl || 0,
            ...
            _(he).then(t=>{
                t.wait().then(e=>{
                    if (e.type == o.Yes) {
                        ...
                        this.checkStop = !!e.data[0],
                        this.autoNumArr = [1, e.data[1]],
        ...
        doAutoFish() {
            ...
            i.play(1, !1, Laya.Handler.create(null, ()=>{
                ...
                N.fish.reqFishing(1).then(t=>{
                    ...
                    this.showAutoFish(t),
                    this.autoNumArr[0] > this.autoNumArr[1] ? this.onClickStop() : this.checkStop && t.myNewMax > t.myOldMax && (_(ue, {
                        params: [t, !0, e],
                        closeOnSide: !0
                    }).then(t=>{
                        t.wait().then(()=>{
    ...
    L([D(l.FISHCOIN_CHANGE)], ke.prototype, "showFishBait", null),
    L([D(l.DO_CONTINUE_FISH)], ke.prototype, "onClickStart", null),
    L([D(l.UPDATE_FISH_SYS)], ke.prototype, "addSys", null),
    L([D(l.UPDATE_ITEM)], ke.prototype, "updateGold", null),
    L([D(l.FISHDATA_CHANGE)], ke.prototype, "checkFomoAni", null);
    class we extends t.cat.views.home.ShopDlgUI {
        constructor() {
            super(...arguments),
            this.m_mouseDown = !1,
            this.m_mouseY = 0,
        ...
        updateShowView(t=!1) {
            ...
            var e = Data.getShopCat(N.cat.getMyLv())
              , t = (t && (N.cat.freeCat ? this.m_lst_Cat.scrollTo(Math.max(0, N.cat.freeCat - 5)) : this.m_lst_Cat.scrollTo(Math.max(0, Math.max(e.fishCoinLvl, e.goldLvl) - 5))),
            this.m_lst_Cat.array = Object.keys(Data.Cats),
            Data.gameConf.initCfg.openFuc.split(","))
              , e = N.cat.getMyLv();
            this.m_box_Add.visible = e >= +t[0],
    ...
    L([D(l.MaxCAT_CHANGE)], we.prototype, "updateShowView", null),
    L([D(l.BUY_CAT)], we.prototype, "updateGold", null);
    class Se extends t.cat.views.home.SpeedDlgUI {
        constructor() {
            super(...arguments),
        ...
        updateView() {
            ...
            this.m_tick = I.create(1e3 * this.m_speedEndTime, 1e3, this.m_txt_Time),
            this.m_tick.start(),
            this.m_tick.onTick = ()=>{
                var t = 1e3 * this.m_speedEndTime - Date.newDate().getTime();
                this.m_pbr_Time.value = t / (1e3 * +Data.gameConf.upSpeedCfg.maxTime)
            ...
            this.m_tickFree = I.create(1e3 * +this.m_freeEndTime, 1e3, this.m_txt_FreeCd),
            ...
            this.ani1.stop(),
            this.m_tickChain = I.create(1e3 * +this.m_CEndTime, 1e3, this.m_txt_ChainCd),
        ...
        onClickFree() {
            1e3 * this.m_freeEndTime > Date.newDate().getTime() || N.cat.reqSpeed(1).then(t=>{
                S.exdata.speedFreeTime = this.m_freeEndTime = +t.SpeedFreeTime,
                S.boostEndTime = this.m_speedEndTime = +t.boostEndTime,
        ...
        sendTransaction() {
            if (this.m_payData) {
                ...
                Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE && Laya.Browser.onMobile ? _(ye, {
                    ...
                    t.wait().then(t=>{
                        t.type == o.Yes && (this.lockChainOperate(),
                        N.wallet.sendTransaction(8e6, e, i, Gt.signIn, t.data).then(()=>{
                            var t;
                            this.destroyed || (t = (new Date).getTime(),
                            w.set(w.s_signInSpeedOrderTime, t),
                            this.checkChainConfirm())
                        }
                        ).catch(()=>{
                            this.unlockChainOperate()
                ...
                N.wallet.sendTransaction(8e6, e, i, Gt.signIn).then(()=>{
                    var t;
                    this.destroyed || (t = (new Date).getTime(),
                    w.set(w.s_signInSpeedOrderTime, t),
                    this.checkChainConfirm())
    ...
    L([D(l.UPDATE_SPEED)], Se.prototype, "updateView", null);
    class xe extends t.cat.views.home.UpGradeDlgUI {
        constructor(t) {
            super(),
            this.cat = t
        }
        ...
        onClickShare() {
            S.doShareToTg(1, +Data.getCat(this.cat - 1).showId)
        }
    }
    class Le extends t.cat.views.squad.SquadBoostDlgUI {
        constructor(t) {
            super(),
            this.m_lastIndex = -1,
            this.m_clubId = 0,
        ...
        onAwake() {
            super.onAwake(),
            this.addTitle(),
            N.club.reqGetRecruitListClub().then(t=>{
                this.showUI(t)
            }
            )
        }
    ...
    class De extends t.cat.views.squad.TotalScoreDetailDlgUI {
        constructor(t) {
            super(),
    ...
    class Ie extends t.cat.views.squad.TotalScoreShowDlgUI {
        constructor() {
            super(...arguments),
            this.m_showData = null
        }
        ...
        showUI() {
            ...
            this.m_txt_TPlayers.text = Wt(this.m_showData.totalPlayers || 0),
            this.m_txt_DailyNum.text = Wt(this.m_showData.dailyUsers || 0),
            this.m_txt_NumOl.text = Wt(this.m_showData.online || 0),
            this.m_txt_NumPrem.text = Wt(this.m_showData.premiumPlayers || 0);
    ...
    class Re extends t.cat.views.squad.RankCellViewUI {
        dataChanged(t, e) {
    ...
    Re.CheckFlagNum = 0;
    class Te extends t.cat.views.squad.SquadRankListDlgUI {
        constructor(t=0, e=!1) {
            super(),
            this.m_listType = 0,
            this.m_listTypeP = 0,
        ...
        changeLeagueShow() {
            ...
            var t = Data.gameConf.initCfg.minerLeagues.split(",")
              ...
              , i = (this.m_txt_Level.text = v(1006, v(Ft[this.m_league])),
            this.getRankList(),
            ...
            this.m_pbr_Score.value = +s / +e[this.m_league + 1] || 0)) : (0 == this.m_listTypeP ? this.m_txt_Tips.text = v(1005, f(+t[this.m_league])) : this.m_txt_Tips.text = v(1005, f(+e[this.m_league])),
            this.m_txt_Tips.visible = !0,
        ...
        changeStatusShow() {
            N.club.reqGetStats().then(t=>{
                this.m_headShowed = !0,
                this.m_txt_TotalPlayers.text = Wt(t.totalPlayers) + " Catizens";
        ...
        getRankList() {
            ...
            N.club.reqGetClubGoldRankList(this.m_league, this.m_listType).then(t=>{
                if (!this.destroyed) {
                    let i = [];
                    if (t.rankList.forEach(t=>{
                        i.push({
        ...
        getCellView(e, i) {
            ...
            t ? (t.dataChanged(i, e),
            t.y = 94 * i,
            this.m_box_ListCon.addChild(t)) : u(Re, {}).then(t=>{
    ...
    class Ee extends t.cat.views.squad.SquadInfoDlgUI {
        constructor(t=0) {
            super(),
            this.m_clubId = 0,
            this.m_listType = 0,
        ...
        showUI(t) {
            ...
            this.m_txt_Level.text = v(Ft[t.league]),
            this.m_view_Head.setHeadShow({
                isCircle: !1,
                uname: t.name,
                icoUrl: t.icon + "",
        ...
        onClickLeague() {
            this.m_clubData && d(Te, {
                params: [this.m_clubData.league, !0]
            })
        }
        onClickJoin() {
            this.m_btn_Join.disabled = !0,
            N.club.reqJoinClub(this.m_clubId).then(t=>{
                this.showUI(t.club),
        ...
        getRankList() {
            this.changeTxtColor(),
            N.club.reqClubMemberRank(this.m_clubId, this.m_listType).then(t=>{
                let e = [];
        ...
        getCellView(e, i) {
            ...
            t ? (t.dataChanged(i, e),
            t.y = 94 * i,
            this.m_box_SquadCon.addChild(t)) : u(Re, {}).then(t=>{
                this.destroyed ? t.destroy() : (t.dataChanged(i, e),
                t.y = 94 * i,
    ...
    class Ae extends t.cat.views.squad.JoinSquadListDlgUI {
        onAwake() {
            super.onAwake(),
            this.addTitle(),
    ...
    class Me extends t.cat.views.squad.InviteDetailShowDlgUI {
        constructor(t) {
            super(),
            this.m_showDouble = !1,
            this.m_showDouble = t
    ...
    class Ne extends t.cat.views.squad.InvitePartyKingsDlgUI {
        onAwake() {
            super.onAwake(),
            this.addTitle(),
            N.invite.reqInviteRankList().then(t=>{
                this.showUI(t)
            }
            )
        }
    ...
    class Fe extends t.cat.views.squad.FrenZoneDlgUI {
        constructor() {
            super(...arguments),
            this.m_cellPool = [],
            this.m_cellDataList = [],
        ...
        showUI(t) {
            ...
            var e = t.friendList.length
              , e = (this.onScrollChange(),
            0 < t.inviteCount && (this.m_txt_Title.text = 1 == e ? v(1031) : v(1032, t.inviteCount)),
            this.m_img_NoFriend.visible = e <= 0,
            this.m_box_ListCon.height = 150 * e,
            0 == e ? (this.m_box_Friend.height = 250,
            this.m_img_ConBg.bottom = 50) : (1 < e ? (this.m_box_Friend.height = 150 * e + 185,
            ...
            this.m_txt_inviteBase0.text = "+" + e[0],
            this.m_txt_invitePr0.text = "+" + i[0],
            this.m_txt_Total.text = "+" + f(t.fishCoin),
        ...
        checkDoubleShow(t) {
            ...
            this.m_showDouble ? (this.m_box_Double.visible = !0,
            this.m_box_Event.visible = !0,
            this.m_box_EventOut.y = 403,
            this.m_ticker = I.create(t, 1e3, this.m_txt_TimeEnd),
            this.m_ticker.start()) : (this.m_box_Event.visible = !1,
            this.m_box_Double.visible = !1,
            this.m_box_EventOut.y = 153),
            this.m_box_Con.height = this.m_box_EventOut.height + this.m_box_EventOut.y + 50,
            this.m_pan_Con.refresh()
        }
        onClickTopLeaders(t) {
            d(Ne)
        ...
        getCellView(e, i) {
            ...
            t ? (t.dataChanged(i, e),
            t.y = 150 * i,
            this.m_box_ListCon.addChild(t)) : u(Pe, {}).then(t=>{
                this.destroyed ? t.destroy() : (t.dataChanged(i, e),
                t.y = 150 * i,
                this.m_box_ListCon.addChild(t))
            }
    ...
    class Be extends t.cat.views.home.OffLineDlgUI {
        constructor(t) {
            super(),
            this.m_off = t
        }
    ...
    class Ue extends t.cat.views.common.FingerViewUI {
    }
    class Ge extends t.cat.views.home.FirstRechargeDlgUI {
        constructor() {
            super(...arguments),
            this.m_goodId = 1001
        }
        ...
        showUI() {
            ...
            this.m_txt_FishCoin.text = Wt(e.fishCoin),
            this.m_txt_Gold.text = Wt(+e.gold),
        ...
        onClickBuy(t) {
            ...
            S.requestPrePay(this.m_goodId).then(t=>{
                ...
                _(ve, {
                    ...
                    t.wait().then(t=>{
                        t.type == o.Yes && (t.data && t.data.isTonWallet ? this.showPayProcessing(3e3) : (t = (new Date).getTime(),
                        w.set(w.s_firstRechargeOrderTime, t),
                        this.showUI(),
    ...
    L([D(l.RECHARGE_SUCCESS)], Ge.prototype, "doClose", null);
    class qe extends t.cat.views.home.RandomEventsDlgUI {
        constructor(t, e=!1) {
            super(),
            this.m_spine = null,
            this.m_spineStr = "",
        ...
        onAwake() {
            super.onAwake();
            var t = S.randomEvent;
            t && (this.m_spine || (this.m_spine = R.create({
            ...
            t.type == Mt.multiple ? (this.m_spine.play(2, !0),
            this.m_txt_Middle.text = v(1041),
            this.m_txt_Right.text = v(1040)) : (this.m_spine.play(3, !0),
            this.m_txt_Middle.text = v(1043),
            this.m_txt_Right.text = v(1042))),
            Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE ? this.m_img_Chain.skin = "cat/ui_comm/mantle.png" : this.m_img_Chain.skin = "cat/ui_comm/ton.png",
            t.type == Mt.multiple ? (t = Data.gameConf.randomEventCfg.multipleTimes.split(","),
    ...
    qe.ChainFlag = !1,
    L([D(l.RANDOM_EVENT_TIME_CHANGE)], qe.prototype, "doClose", null);
    class Oe extends t.cat.views.home.AutoDlgUI {
        onAwake() {
            super.onAwake(),
    ...
    class He extends t.cat.views.lunchPool.BoostMiningDlgUI {
        onAwake() {
            super.onAwake(),
            this.showUI()
        }
        ...
        showUI() {
            ...
            this.m_tick = I.create(a, 1e3, this.m_txt_Time),
            this.m_tick.start(),
            this.m_txt_Time.visible = !0,
            ...
            this.m_div_Info.innerHTML = v(2027, "&nbsp;" + e + "&nbsp;", "&nbsp;" + +s / 3600),
    ...
    L([D("updateLunchList")], He.prototype, "showUI", null);
    class We extends t.cat.views.lunchPool.AssetsDlgUI {
        onAwake() {
            super.onAwake(),
            this.updateView()
        }
    ...
    class Ve extends Laya.EventDispatcher {
        ...
        updateValue() {
            ...
            this._showTime && this.timeLabel && (this.timeLabel.text = le((this._showTime - Date.newDate().getTime()) / 1e3, "MM:ss")),
    ...
    class Ye extends t.cat.views.lunchPool.LunchDetailViewUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
        ...
        updateCatPool(t) {
            ...
            this.m_txt_Stake1.text = (t.totalStake || 0) + " $",
            this.m_txt_Day1.text = +le(+this.m_data.endTime - +this.m_data.startTime, "D") + " day/s",
        ...
        updateFishPool(t) {
            ...
            this.m_txt_Stake2.text = (t.totalStake || 0) + " Fish",
            this.m_txt_Day2.text = +le(+this.m_data.endTime - +this.m_data.startTime, "D") + " day/s",
            this.m_txt_Join2.text = (t.totalPlayer || 0) + ""
        }
    }
    class Xe extends t.cat.views.lunchPool.StakeCatDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
        ...
        onClickOk() {
            +N.cat.findMaxCat() < this.m_data.catPool.stakeLimit || (N.lunch.reqStack(this.m_data.catPool.id, 0, this.m_data.id),
            this.closeDialog())
        }
    }
    class ze extends t.cat.views.lunchPool.StakeFishDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
        onAwake() {
            super.onAwake(),
            this.m_view_Fish.setData(1, Math.max(S.fishCoin, this.m_data.fishPool.stakeLimit), this.m_data.fishPool.stakeLimit, ""),
            this.updateView()
        }
        updateView() {
            this.m_txt_Stake.text = this.m_view_Fish.count + "/",
            this.m_txt_Num.text = S.fishCoin + "",
            this.m_txt_Num.color = S.fishCoin >= this.m_data.fishPool.stakeLimit ? "#764428" : Jt.Red
        }
        onClickOk() {
            if (S.fishCoin < this.m_data.fishPool.stakeLimit)
                return _(T, {});
            N.lunch.reqStack(this.m_data.fishPool.id, this.m_view_Fish.count, this.m_data.id),
            this.closeDialog()
        }
    }
    L([D(l.FISHCOIN_CHANGE), D(l.COUNT_CHANGE)], ze.prototype, "updateView", null);
    class je extends t.cat.views.lunchPool.StakeCatBackDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
        ...
        onClickOk() {
            N.lunch.reqStack(this.m_data.catPool.id, 0, this.m_data.id, 1),
            this.closeDialog()
        }
    }
    class $e extends t.cat.views.lunchPool.StakeFishBackDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
        ...
        updateView() {}
        onClickOk() {
            N.lunch.reqStack(this.m_data.fishPool.id, this.m_data.fishPool.myStake, this.m_data.id, 1),
            this.closeDialog()
        }
    }
    class Ke extends t.cat.views.lunchPool.LunchInfoViewUI {
        constructor(t) {
            super(),
            this.m_mask1 = new Ve,
            this.m_mask2 = new Ve,
        ...
        updateView() {
            if (this.m_data = N.lunch.getLunchById(this.m_data.id),
            this.m_data) {
                var t;
                if (Date.newDate().getTime() / 1e3 > +this.m_data.endTime)
                    return this.m_pan_Panel.visible = !1,
                    this.m_box_End.visible = !0,
                    t = v(Data.getLaunch(this.m_data.id).name),
                    this.m_txt_End1.text = this.m_data.catPool.gotScore + " " + t,
                    void (this.m_txt_End2.text = this.m_data.fishPool.gotScore + " " + t);
                this.updateCatPool(this.m_data.catPool),
                this.updateFishPool(this.m_data.fishPool),
        ...
        updateCatPool(t) {
            ...
            this.m_txt_Sum1.text = (this.m_data.catPool.totalStake || 0) + " $",
            this.m_txt_Got1.text = (t.gotScore || 0) + " " + i,
            this.m_txt_Wait1.text = (t.waitScore || 0) + " " + i,
            this.m_txt_MyScore1.text = (t.myStake || 0) + " $",
        ...
        updateFishPool(t) {
            ...
            v(Data.getLaunch(this.m_data.id).name));
            this.m_btn_Out2.visible = this.m_btn_In2.visible && !!t.myStake,
            this.m_txt_Sum2.text = (this.m_data.fishPool.totalStake || 0) + " Fish",
            this.m_txt_Got2.text = (t.gotScore || 0) + " " + i,
            this.m_txt_Wait2.text = (t.waitScore || 0) + " " + i,
            this.m_txt_MyScore2.text = (t.myStake || 0) + " Fish",
    ...
    L([D(l.UPDATE_LUNCH)], Ke.prototype, "updateView", null),
    L([D(l.POOLBONUS)], Ke.prototype, "updateBonus", null);
    class Je extends t.cat.views.lunchPool.LunchDlgUI {
        constructor(t) {
            super(),
            this.m_data = t
        }
        ...
        updateView() {
            ...
            this.m_txt_Name.text = v(this.m_data.name),
            this.m_txt_Sum.text = Intl.NumberFormat().format(+this.m_data.totalScore),
            this.m_img_State.skin = "cat/ui_lunch/preparation.png",
            this.m_txt_Last.text = +le(+this.m_data.endTime - +this.m_data.startTime, "D") + " day/s";
            var t = Date.newDate().getTime() / 1e3;
            t < +this.m_data.startTime ? (this.m_txt_TimeDesc.text = v(11001),
            this.m_tick = I.create(1e3 * +this.m_data.startTime, 1e3, this.m_txt_Time, "D:HH:MM:ss"),
            this.m_tick.onEnd = ()=>{
                this.updateView()
            }
            ,
            this.m_tick.start()) : t < +this.m_data.endTime ? (this.m_txt_TimeDesc.text = v(11003),
            this.m_img_State.skin = "cat/ui_lunch/mining.png",
            this.m_tick = I.create(1e3 * +this.m_data.endTime, 1e3, this.m_txt_Time, "D:HH:MM:ss"),
            this.m_tick.onEnd = ()=>{
                this.updateView()
            }
            ,
            this.m_tick.start()) : (this.m_txt_TimeDesc.text = v(11002),
            this.m_img_State.skin = "cat/ui_lunch/completed.png",
            this.m_txt_Time.text = wt(Date.newDate(1e3 * +this.m_data.endTime), "yyyy-mm-dd")),
            this.checkBoostShow()
        }
        onClickBoost() {
            _(He)
        ...
        checkBoostShow() {
            ...
            1e3 * +N.lunch.boostEndTime)
              , i = Date.newDate().getTime();
            !(+N.lunch.inviterNum < +t) && i < e ? (this.m_tickBoost && this.m_tickBoost.dispose(),
            this.m_tickBoost = I.create(e, 1e3, this.m_txt_BoostEnd),
            ...
            this.m_btn_Boost.label = v(2028))
        }
    }
    L([D("updateLunch")], Je.prototype, "updateView", null);
    class Ze extends t.cat.views.lunchPool.LunchCellViewUI {
        constructor(t) {
            super(),
            this.m_mask1 = new Ve,
            this.m_mask2 = new Ve,
        ...
        updateView() {
            ...
            this.m_txt_Name.text = v(e.name) + "",
            this.m_txt_Sum.text = Intl.NumberFormat().format(+e.totalScore),
            this.m_txt_Last.text = +le(+e.endTime - +e.startTime, "D") + " day/s";
            var i = Date.newDate().getTime() / 1e3;
            if (this.m_tick && this.m_tick.dispose(),
            this.m_txt_CatDesc1.text = v(e.catPool.scoreRate) + "%",
            this.m_txt_FishDesc1.text = v(e.fishPool.scoreRate) + "%",
            ...
            this.m_txt_TimeDesc.text = v(11001),
            this.m_tick = I.create(1e3 * +e.startTime, 1e3, this.m_txt_Time, "D:HH:MM:ss"),
            this.m_tick.onEnd = ()=>{
                this.updateView()
            }
            ,
            this.m_tick.start(),
            this.m_txt_CatDesc1.text = v(11004, e.catPool.scoreRate + "%"),
            this.m_txt_FishDesc1.text = v(11004, e.fishPool.scoreRate + "%")) : (i < +e.endTime ? (this.m_txt_TimeDesc.text = v(11003),
            this.m_img_State.skin = "cat/ui_lunch/mining.png",
            this.m_tick = I.create(1e3 * +e.endTime, 1e3, this.m_txt_Time, "D:HH:MM:ss"),
            this.m_tick.onEnd = ()=>{
                this.updateView()
            }
            ,
            ...
            this.m_img_State.skin = "cat/ui_lunch/completed.png",
            this.m_txt_TimeDesc.text = v(11002),
            this.m_btn_Stake1.visible = this.m_btn_Stake2.visible = !1,
            this.m_txt_Time.text = wt(Date.newDate(1e3 * +e.endTime), "yyyy-mm-dd")),
            e.catPool.myStake && (this.m_btn_Stake1.visible = !1,
            this.m_img_Cd1.visible = !0),
            this.m_txt_Stake1.text = (e.catPool.myStake || 0) + " $",
            this.m_txt_People1.text = (e.catPool.totalPlayer || 0) + "",
            this.m_txt_Sum1.text = e.catPool.totalStake + " $",
            e.fishPool.myStake && (this.m_btn_Stake2.visible = !1,
            this.m_img_Cd2.visible = !0),
            this.m_txt_Stake2.text = (e.fishPool.myStake || 0) + " Fish",
            this.m_txt_People2.text = (e.fishPool.totalPlayer || 0) + "",
            this.m_txt_Sum2.text = e.fishPool.totalStake + " Fish"),
            i < +e.endTime) {
                this.height = 800;
                let t = 0;
        ...
        updateLunch() {
            this.m_data && (this.m_data = N.lunch.getLunchById(this.m_data.id),
            this.updateView())
        }
    }
    L([D(l.UPDATE_LUNCH), D(l.UPDATE_LUNCH)], Ze.prototype, "updateLunch", null);
    class Qe extends t.cat.views.lunchPool.LunchListDlgUI {
        constructor() {
            super(...arguments),
        ...
        onDestroy() {
            super.onDestroy(),
            N.lunch.isLunchDlg = !1,
            this.m_tickBoost && this.m_tickBoost.dispose()
        }
        updateView() {
            this.m_box_Vbox.destroyChildren();
            for (var t of N.lunch.m_lunchs)
                u(Ze, {
                    params: [t]
                }).then(t=>{
                    this.m_box_Vbox.addChild(t)
        ...
        checkBoostShow(t) {
            ...
            this.m_tickBoost = I.create(i, 1e3, this.m_txt_BoostEnd),
            this.m_tickBoost.start(),
            this.m_btn_Boost.label = "",
            this.m_box_Speed.visible = !0,
    ...
    L([D("updateLunch")], Qe.prototype, "updateView", null);
    class E extends t.cat.views.home.OfficeDlgUI {
        ...
        onAwake() {
            ...
            this.m_btn_ReCharge.x = 6 - t / 2 * (2 / 3),
            this.m_btn_Mine.x = 107 - t / 2 * (1 / 3),
            this.m_btn_Shop.x = 360 + t / 2 * (1 / 3),
            this.m_btn_Invite.x = 461 + t / 2 * (2 / 3),
            x.instance.playMusic("BGM_Cafe.mp3"),
        ...
        checkLink() {
            S.linkType == y.Recharge || S.linkType == y.ConnectWalletForBuyFishRecharge ? _(T) : S.linkType == y.ConnectWalletForClubRecharge ? this.onClickSquad() : S.linkType == y.ConnectWalletForSignInSpeed ? _(Se) : S.linkType == y.ConnectWalletForFirstRecharge && _(Ge)
        }
        checkCreateTip() {
        ...
        checkOffLine() {
            S.offLine && S.offLine.length ? (s.instance.removeAllPopup(),
            _(Be, {
                params: [S.offLine]
            }).then(t=>{
                t.wait().then(()=>{
            ...
            S.offLine = 0) : (this.m_offLineShowed = !0,
            this.checkShowRandomEvent(!0))
        }
        onDestroy() {
            super.onDestroy(),
        ...
        updateOutPut(t=!1) {
            ...
            this.m_txt_Price.text = f(N.cat.getNowPrice()) + "",
            this.m_txt_Speed.text = f(N.cat.getOutPutSpeed()) + "/s",
                            ...
                            if (!e.isDone && s - a > 1e3 * i.interval + 1e3)
                                ...
                                e.on(Laya.Event.CLICK, this, (t,e=!1)=>{
                                    ...
                                    _(qe, {
                                        ...
                                        t.wait().then(t=>{
                                            t.type != o.No && t.type != o.None || qe.ChainFlag || S.reqGetRandomEventAward(At.close),
        ...
        doRandomSpineAni() {
            ...
            if (s) {
                var a = S.randomEvent
                  ...
                  , o = a && 1e3 * +a.time || 0;
                let e = !1
                  , t = (!a.isDone && n - o > 1e3 * +Data.gameConf.randomEventCfg.disappearTime && (e = !0),
                0)
                  , i = 0;
                i = (t = e ? .5 < Math.random() ? Math.randRange(-80, -20) : Math.randRange(580, 640) : Math.randRange(50, 520),
                Math.randRange(50, 400)),
                t > s.x ? s.scaleX = -1 * Math.abs(s.scaleX) : s.scaleX = +Math.abs(s.scaleX),
                s.play(0, !0);
                a = Ot(t, i, s.x, s.y);
                Laya.Tween.to(s, {
                    x: t,
                    ...
                    e ? (N.cat.isAuto && S.reqGetRandomEventAward(At.free),
        ...
        updateRechargeShow() {}
        onClickReCharge() {
            _(S.checkFirstReCharge() ? T : Ge)
        }
        onClickSquad() {
            N.club.clubInfo ? d(Ee, {
        ...
        updateSpeed() {
            N.cat.checkIsBoost() ? this.ani13.play(0, !0) : this.ani13.stop(),
            this.checkCatSpeed()
        }
        checkCatSpeed() {
            for (var t of this.catSpines)
                t && t._skeleton && t._skeleton.playbackRate(N.cat.checkIsBoost() ? this.m_speedScale : 1)
        }
        onClickShop() {
            _(we)
        }
        moveCat(i) {
            ...
            if (!this.destroyed) {
                ...
                this.m_lst_Cat.once(Laya.Event.MOUSE_UP, this, t=>{
                    ...
                    N.event(l.CAT_MATCH),
                    N.cat.airDropMap[i.index] || !N.cat.allcats[i.index] || N.lunch.checkCatLunch(i.index) ? this.showDelete(!1) : (e.visible = !0,
                    i.catId != Data.maxCats && this.checkChangeCell(i, i.index, t),
                ...
                this.m_lst_Cat.once(Laya.Event.MOUSE_OUT, this, ()=>{
                    ...
                    N.event(l.CAT_MATCH),
                    this.showDelete(!1),
                    i && N.cat.allcats[i.index] && (e.visible = !0,
        ...
        showDelete(t) {
            ...
            this.m_btn_Generate.visible = this.m_btn_ReCharge.visible = this.m_btn_Invite.visible = this.m_btn_Shop.visible = this.m_btn_Mine.visible = !t;
            var t = Data.gameConf.initCfg.openFuc.split(",")
              , e = N.cat.getMyLv();
            this.m_btn_Auto.visible = this.m_btn_Generate.visible && e >= +t[2]
        }
        checkChangeCell(a, n, t) {
            if (oe("checkMouse", 500)) {
        ...
        updateClubShow() {
            ...
            N.club.clubInfo) {
                ...
                this.m_txt_SquadScore.text = f(N.club.clubInfo.rankGold),
                this.m_txt_League.text = v(Ft[N.club.clubInfo.league]),
                this.m_img_Cup.skin = `cat/ui_notpack/cup${this.changeImgUrl(N.club.clubInfo.league)}.png`
            }
        }
        updateRankShow() {
            N.club.reqGetMyRank().then(t=>{
                this.m_txt_SelfLeague.text = v(Ft[t.league]),
        ...
        findCustomCat() {
            this.catSpines.find(t=>!!t && !t.destroyed) ? (this.m_speedFlag = N.cat.checkIsBoost(),
        ...
        randomPeople(s, a) {
            ...
            var r, l = s, c = a, m = Math.randRange(1, 3), d = "hair", _ = ("female" == c && .5 < Math.random() ? (e = l.getSlotByName("hair_long"),
            ...
            function s(o, h, r, l) {
                ...
                Laya.timer.once(5200 * r / (this.m_speedFlag ? this.m_speedScale : 1), this, ()=>{
                    N.cat.prepareCat(c, d, Laya.Handler.create(this, ()=>{
                        ...
                        N.cat.goldMute || 1 != r || x.instance.playSound("SFX_DoorBell.mp3"),
                        c.play("wave", !0),
                        N.cat.goldMute || x.instance.playSound(N.cat.getCv("Hello", m)),
                            ...
                            Laya.Tween.to(c, {
                                ...
                                Laya.timer.once(e / (this.m_speedFlag ? this.m_speedScale : 1), this, ()=>{
                                    ...
                                    Laya.timer.once(this.m_speedFlag ? 3800 / this.m_speedScale : 1e3, this, ()=>{
                                        ...
                                        n = l,
                                        s.play("walk", !0),
                                        N.cat.goldMute || x.instance.playSound(N.cat.getCv("Thanks", t)),
        ...
        checkTaskRed() {
            ...
            N.cat.getMyLv() < +e[1] || (e = Mmobay.LocalStorage.get(w.s_taskRedCheck),
            t = Date.newDate().getTime(),
            !e || 864e5 < t - e ? (this.m_img_TaskRed.visible = !0,
            Mmobay.LocalStorage.set(w.s_taskRedCheck, t)) : this.m_img_TaskRed.visible = !1)
        }
        checkNew() {
            N.cat.checkNew() && u(Ue, {
                params: []
        ...
        checkOpenMenu() {
            var t = Data.gameConf.initCfg.openMenu.split(",")
              , e = N.cat.getMyLv();
            this.m_btn_ReCharge.gray = e < +t[0],
            this.m_btn_Speed.gray && e >= +t[1] && this.checkFreeBoostRed(!0),
            this.m_btn_Speed.gray = e < +t[1],
            this.m_btn_Shop.gray && e >= +t[2] && this.updateShopRed(),
            this.m_btn_Shop.gray = e < +t[2],
            this.m_btn_Invite.gray = e < +t[3],
            this.m_btn_Mine.gray = e < +t[4],
            this.m_btn_ReCharge.mouseEnabled = e >= +t[0],
            this.m_btn_Speed.mouseEnabled = e >= +t[1],
            this.m_btn_Shop.mouseEnabled = e >= +t[2],
            this.m_btn_Invite.mouseEnabled = e >= +t[3],
            this.m_btn_Mine.mouseEnabled = e >= (+t[4] || 0)
        }
        checkSum() {
        ...
        checkFreeBoostRed(t=!1) {
            ...
            this.m_img_RedSpeed.visible = 0 < e && (!this.m_btn_Speed.gray || t),
            !this.m_img_RedSpeed.visible && e < 0 && Laya.timer.once(1e3 - e, this, this.checkFreeBoostRed)
        }
        onClickSound() {
            var t = x.instance.soundEnable;
            x.instance.soundEnable = !t,
            x.instance.musicEnable = !t,
            w.set(w.s_musicDisable, t),
            w.set(w.s_soundDisable, t),
            t ? x.instance.stopAll() : x.instance.playMusic("BGM_Cafe.mp3"),
            this.checkSoundImgShow()
        }
        checkSoundImgShow() {
            var t = x.instance.soundEnable;
        ...
        checkAuto() {
            ...
            if (N.cat.isAuto && !N.lunch.isLunchDlg) {
                ...
                s.length) {
                    ...
                    12 == N.cat.allcats.filter(t=>!!t).length && this.delLastCat()
            }
        }
        delLastCat() {
            let t = !1;
        ...
        checkGoldRain() {
            ...
            Laya.timer.once(Math.max(t, e, 0), this, this.doReCheckGoldRain)) : N.cat.clearGoldRain()
        }
        doReCheckGoldRain() {
            N.event(l.UPDATE_SPEED),
            this.checkGoldRain()
        ...
        updateFuc() {
            var t = Data.gameConf.initCfg.openFuc.split(",")
              , e = N.cat.getMyLv();
            !this.m_btn_Task.visible && e >= +t[1] && this.checkTaskRed(),
            this.m_box_Plus.visible = this.m_btn_Fish.visible = this.m_txt_Fish.visible = this.m_img_Fish.visible = e >= +t[0],
            this.m_btn_Task.visible = this.m_img_Task1.visible = this.m_txt_Task.visible = e >= +t[1],
            this.m_btn_Auto.visible = e >= +t[2] && this.m_btn_Generate.visible,
            this.m_img_AutoRed.visible = !N.cat.buyAuto && this.m_btn_Auto.visible && !N.cat.clickAuto
        }
        changeImgUrl(t) {
            return 5 == t || 6 == t ? t + 1 : t
    ...
    L([D("leaguechange")], E.prototype, "updateBg", null),
    L([D(l.UPDATE_OUTPUT)], E.prototype, "clearSumTip", null),
    L([D(l.UPDATE_OFFLINEGOLD)], E.prototype, "checkOffLine", null),
    L([D(l.UPDATE_ITEM)], E.prototype, "updateGold", null),
    L([D(l.UPDATE_CAT)], E.prototype, "updateOutPut", null),
    L([D(l.UPDATE_ITEM)], E.prototype, "updateRechargeShow", null),
    L([D(l.UPDATE_OUTPUT), D(l.UPDATE_SPEED)], E.prototype, "refreshOutPut", null),
    L([D(l.BUY_CAT)], E.prototype, "buyCat", null),
    L([D(l.UPDATE_SPEED)], E.prototype, "updateSpeed", null),
    L([D(l.MOVE_CAT)], E.prototype, "moveCat", null),
    L([D(l.CLUB_UPDATE)], E.prototype, "updateClubShow", null),
    L([D(l.HOME_GOLD_ANI)], E.prototype, "showGoldAni", null),
    L([D(l.AIR_DROP)], E.prototype, "airDrop", null),
    L([D(l.OPNE_AIR_DROP)], E.prototype, "opAirDrop", null),
    L([D(l.SPEED_FREE), D("buyAuto")], E.prototype, "checkFreeBoostRed", null),
    L([D("updateShopRed")], E.prototype, "updateShopRed", null),
    L([D("buyAuto")], E.prototype, "buyAuto", null),
    L([D(l.RANDOM_EVENT_TIME_CHANGE)], E.prototype, "checkGoldRain", null);
    class ti extends t.cat.views.recharge.RechargeSuccessDlgUI {
        constructor(t, e) {
            super(),
            this.m_amount = 0,
            this.m_gold = 0,
        ...
        onAwake() {
            ...
            0 < this.m_amount && (this.m_txt_Amount.text = Wt(this.m_amount)),
            0 < this.m_gold && (this.m_txt_Gold.text = Wt(this.m_gold))
        }
    }
    class ei extends t.cat.views.entrance.GameEntranceUI {
        constructor() {
            super(),
            this.m_resArr = [],
            this.size(560, 1120),
    ...
    L([D(l.RECHARGE_SUCCESS)], ei.prototype, "onRechargeSuccess", null);
    class A extends t.cat.views.common.LoadingViewUI {
        static show() {
            ...
            A.s_instance)
                ...
                let t = new A;
                t.openView().then(()=>{
                    A.s_instance || A.s_count <= 0 ? t.destroy() : (dt(A.s_instance = t, c.Loading),
                    t.play())
                }
                )
            }
    ...
    A.s_count = 0;
    class ii extends t.cat.views.common.ToastViewUI {
        constructor(t) {
            super(),
            this.m_info = t
        }
    ...
    class si extends t.cat.views.common.MsgBoxUI {
        constructor(t) {
            super(),
            this.m_option = t
        }
        onAwake() {
            ...
            this.m_option.leading && (si.s_style.leading = this.m_option.leading),
            this.m_option.fontSize && (si.s_style.fontSize = this.m_option.fontSize),
            Object.assign(this.m_div_Msg.style, si.s_style),
            this.m_div_Msg.innerHTML = Bt(this.m_option.msg),
    ...
    class ai extends t.cat.views.common.WifiViewUI {
        static show() {
            if (ai.s_instance)
                ai.s_instance.play();
            else {
                let t = new ai;
                t.openView().then(()=>{
                    ai.s_instance ? t.destroy() : (dt(ai.s_instance = t, c.Loading),
                    t.play())
                }
                )
            }
        ...
        static clear() {
            ai.s_instance && ai.s_instance.stop()
        }
        play() {
            this.visible = !0,
            this.ani1.isPlaying || this.ani1.play(0, !0)
    ...
    function ni() {
        ...
        var t, e = {
            ...
            loadingImpl: ()=>ut(),
            errorSpawnImpl: (t,e)=>{
                -1 != t && -2 != t && g(Bt((e = Kt(t) || e) || "unknown error"))
            }
        };
        for (t in e = e || et)
            it[t] = e[t];
    ...
    function oi() {
        ei.init();
        N.loadData("cat/data.json").then(t=>(Mmobay.gameDispatcher.event(Mmobay.MEvent.LOAD_PROGRESS, Mmobay.MConst.LOAD_NET),
        N.login.enterGame())).then(t=>{
    ...
    class hi {
        ...
        reqEnterGame(e=!1) {
            ...
            k(t, m.EnterGameReq, pb.IEnterGameAck, {
                noLoading: !0
        ...
        connectGameServer() {
            ...
            .then(()=>{
                ...
                e = ae,
                b.isConnected && t == b.addr ? Promise.resolve(void 0) : (b.connect(t),
                b.messageHandler = e,
                clearTimeout(Ut),
                new Promise((t,e)=>{
        ...
        _disConnectSocketPromise() {
            return new Promise((t,e)=>{
                ...
                i.disconnect(!1),
                Laya.Render.isConchApp && b.event(Laya.Event.CLOSE)) : t()
            }
            )
        }
        _watchGameSocket() {
        ...
        sendHeartBeat() {
            ...
            if (9e3 <= t - this._lastRecvPackTm)
                ...
                return k(pb.HeartBeatReq.create(), m.HeartBeatReq, pb.IHeartBeatAck, {
                    noLoading: !0
                }).then(t=>t)
        }
        onHookSendPacket(t, e) {
        ...
        onServerState(t, e) {
            t == Nt.game && 1 == e && (this._disConnectSocket(),
    ...
    Mmobay.MConfig.showNetLog && (window.sendCommand = function(e) {
        if (Mmobay.MConfig.showNetLog) {
            ...
            return t.command = e,
            k(t, m.CommandReq, pb.ICommandAck).then(t=>(console.log("command:", e),
            t))
        }
    }
    );
    class ri {
        ...
        reqStack(i, t, s, e=0) {
            ...
            a.stakeNum = t,
            a.isRetrieve = e,
            k(a, m.LaunchStakeReq, pb.ILaunchStakeAck, {
                noLoading: !0
            }).then(t=>{
                S.fishCoin = +t.fishCoin,
        ...
        reqReward(i, s) {
            ...
            return t.poolId = i,
            t.launchId = s,
            k(t, m.ReceiveLaunchProfitReq, pb.IReceiveLaunchProfitAck, {
                noLoading: !0
            }).then(t=>{
                for (var e of this.m_lunchs)
                    if (s == e.id) {
    ...
    class li {
        ...
        reqClubInfo(e) {
            ...
            return t.id = e,
            k(t, m.ClubInfoReq, pb.IClubInfoAck).then(t=>(this.clubInfo && this.clubInfo.id == e && (this.clubInfo = t.club,
            N.event(l.CLUB_UPDATE)),
            t))
        }
        reqJoinClub(t) {
            let e = new pb.JoinClubReq;
            return e.id = t,
            k(e, m.JoinClubReq, pb.IJoinClubAck).then(t=>(this.clubInfo = t.club,
            N.event(l.CLUB_UPDATE),
            t))
        }
        reqQuitClub() {
            return k(new pb.QuitClubReq, m.QuitClubReq, pb.IQuitClubAck).then(t=>(this.clubInfo = null,
            N.event(l.CLUB_UPDATE),
            t))
        }
        ...
        reqGetGoldRankList(t=0, e=0) {
            ...
            return i.league = t,
            i.timeType = e,
            k(i, m.GetGoldRankListReq, pb.IGetGoldRankListAck).then(t=>t)
        }
        reqGetClubGoldRankList(t=0, e=0) {
            let i = new pb.GetClubGoldRankListReq;
            return i.league = t,
            i.timeType = e,
            k(i, m.GetClubGoldRankListReq, pb.IGetClubGoldRankListAck).then(t=>t)
        }
        reqGetMyRank() {
            return k(new pb.GetMyRankReq, m.GetMyRankReq, pb.IGetMyRankAck).then(t=>(S.rankGold = t.rankGold,
            S.rankGoldRank = t.rank,
            S.rankLeague = t.league,
        ...
        reqClubMemberRank(t, e=0) {
            ...
            return i.id = t,
            i.timeType = e,
            k(i, m.ClubMemberRankReq, pb.IClubMemberRankAck).then(t=>t)
        }
        reqGetStats() {
            return k(new pb.GetStatsReq, m.GetStatsReq, pb.IGetStatsAck).then(t=>(this.statusImgArr = t.icons || [],
            t))
        }
        getLeagueByScore(e) {
        ...
        getRandomIco(e) {
            ...
            let t = i.slice(0, e);
            return S.icon && -1 == t.indexOf(S.icon) && t.splice(2, 0, S.icon),
            t
        }
    }
    ...
    class ci {
        ...
        reqUnWatch(e) {
            if (e) {
                ...
                k(t, m.UnWatchMsgReq, pb.IUnWatchMsgAck, {
                    noLoading: !0
                })
            }
        }
        ...
        reqWatch(e) {
            if (e) {
                ...
                return t.watchType = e,
                this.watchTypes[e] = 1,
                k(t, m.WatchMsgReq, pb.IWatchMsgAck, {
                    noLoading: !0
                })
            }
        }
        ...
        parseSysMsg(t) {
            ...
            let s = [];
            for (e of t.param)
                e.valType == Tt.lang ? s.push(v(+e.val)) : e.valType == Tt.copper ? (i = e.val,
                s.push(f(i / 60) + "min<img style='height: 20px;width:20px' src='cat/ui_home/img_main_iconsmall_gold.png' />")) : e.valType == Tt.fishcoin ? s.push(+e.val + "<img style='height: 20px;width:20px' src='cat/ui_item/8.png' />") : e.valType == Tt.fishweight ? s.push(+e.val / 1e3 + "t") : s.push((i = e.val,
    ...
    class mi {
        constructor() {
            ...
            t.connectionRestored.then(t=>{
                ...
                N.event(l.WALLET_CONNECTED)) : console.log("Connection was not restored.")
            }
            )
        }
        get connected() {
        ...
        connect() {
            return Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE ? Laya.Browser.onMobile ? Promise.reject("not support") : CatizenWallet.Provider.connect() : (Laya.Browser.onPC && zt(),
            new Promise((e,i)=>{
        ...
        sendTransaction(s, a, n, t, e="") {
            var i;
            return Mmobay.MConfig.channelId == Mmobay.MConst.CHANNEL_MANTLE ? (i = S.id + Date.now() + "",
            t == Gt.signIn ? Laya.Browser.onMobile ? CatizenWallet.Caller.gameSignIn(e, i, n) : CatizenWallet.Provider.gameSignIn(n) : Laya.Browser.onMobile ? CatizenWallet.Caller.recharge(e, i, s + "", n) : CatizenWallet.Provider.recharge(s + "", n)) : (Laya.Browser.onPC && zt(),
            new Promise((t,e)=>{
                this.m_tonConnect.uiOptions = {
                    actionsConfiguration: {
                        twaReturnUrl: this.formatBotLink()
    ...
    class di extends Laya.EventDispatcher {
        constructor() {
            super(...arguments),
            this._dataLoaded = !1,
            this.langJsonUrl = ""
        ...
        loadData(i, s=!1) {
            return new Promise((e,t)=>{
                Laya.loader.loadP(i).then(()=>{
                    ...
                    "" != N.langJsonUrl && (t = Laya.Loader.getRes(N.langJsonUrl)) && (Data.buildData(t),
                    Laya.loader.clearRes(N.langJsonUrl)),
                    s && (this._dataLoaded = !0,
                    this.dispatch(l.DATA_LOADED)),
                    e(0)
                }
                )
            }
    ...
    class _i extends t.cat.views.common.CountViewUI {
        constructor() {
            super(...arguments),
            this.m_count = 0,
            this.m_times = 1,
        ...
        onChangeCount() {
            ...
            this.m_txt_Num.text = v(this.m_txtLang, this.m_count),
            N.event(l.COUNT_CHANGE, this.m_count)
        }
        setCheckTime(t) {
            return this.m_clickTimes.push(t),
            4 < this.m_clickTimes.length && this.m_clickTimes.shift(),
            4 == this.m_clickTimes.length && this.m_clickTimes[3] - this.m_clickTimes[0] < 1e3 && oe("limit", 1e3) && g(v(164)),
            !0
        }
    }
    class ui extends t.cat.views.common.FishCoinViewUI {
        onAwake() {
            super.onAwake(),
            this.updateCoin()
        }
    ...
    L([D(l.UPDATE_ITEM), D(l.FISHCOIN_CHANGE)], ui.prototype, "updateCoin", null);
    class gi extends t.cat.views.common.LvViewUI {
        setData(t) {
            this.m_txt_Lv.text = "" + t
        }
    }
    class pi extends t.cat.views.fish.FishRankCellViewUI {
        dataChanged(t, e) {
            ...
            e) {
                ...
                this.m_txt_Score.text = N.fish.formatWeight(+e.rankData.score);
    ...
    class Ci extends t.cat.views.squad.HeadViewUI {
        constructor() {
            super(...arguments),
            this.m_awaked = !1,
            this.m_data = null
    ...
    class yi extends t.cat.views.fish.FishRewardDetailCellViewUI {
        dataChanged(t, e) {
            var i;
            e ? this.dataSource = e : e = this.dataSource,
            ...
            this.m_txt_Rank.text = v([1017, 1018, 1019][e.settleCfg.id - 1]),
            this.m_img_Rank.skin = `cat/ui_rank/img_ranking_number_${e.settleCfg.id}.png`,
            this.m_img_Rank.visible = !0) : (this.m_txt_Rank.x = 55,
            e.settleCfg.start == e.settleCfg.end ? this.m_txt_Rank.text = v(1021, e.settleCfg.start) : this.m_txt_Rank.text = v(1021, e.settleCfg.start + "~" + e.settleCfg.end),
            this.m_img_Rank.visible = !1),
            this.m_txt_Desc.text = v(1020, e.settleCfg.rewardRate),
            i = f(Math.floor(N.fish.m_fishPool * e.settleCfg.rewardRate / 100)),
            this.m_txt_Reward.text = i + "",
            this.m_img_RewardBg.width = 10 + Math.max(65, this.m_txt_Reward.width) + 50)
        }
    }
    class vi extends t.cat.views.home.SumCatViewUI {
        constructor() {
            super(...arguments),
            this.m_index = null
        }
        ...
        playSumAni(t) {
            var e = Data.getCat(t - 1).showId;
            let i = 1
              , s = (200 <= +e ? i = .8 : 210 < t - 1 && (t = +Data.getCat(t - 1).oldShowId,
            i = 200 <= t ? 1 : 100 <= t ? .9 : .76),
        ...
        updateLunch() {
            this.m_img_Mine.visible = N.lunch.checkCatLunch(this.m_index),
            this.dataSource && (this.m_spine.visible = this.m_view_Lv.visible = !this.m_img_Mine.visible)
        }
    }
    L([D(l.CAT_MATCH)], vi.prototype, "matchEquip", null),
    L([D("updateLunch"), D(l.UPDATE_LUNCH), D(l.POOLBONUS)], vi.prototype, "updateLunch", null);
    class fi extends t.cat.views.home.ShopCellViewUI {
        dataChanged(i, s) {
            if (this.m_index = i,
            ...
            s) {
                ...
                this.m_txt_Buy.text = f(N.cat.getCatCost(s)) + "",
        ...
        onClickBuy() {
            ...
            N.cat.reqCreate(this.dataSource, t).then(()=>{
                g(v(1033)),
                this.m_txt_Buy.text = f(N.cat.getCatCost(this.dataSource)) + ""
            }
            )
        }
    }
    class bi extends t.cat.views.lunchPool.AssetCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
            e && (this.m_txt_Cost.text = "",
            this.m_txt_Name.text = e.name,
            this.m_txt_Num.text = Intl.NumberFormat().format(e.num) + "",
            this.m_img_Icon.skin = e.icon)
        }
    }
    class ki extends Laya.Box {
        constructor() {
            super(...arguments),
            this._constructors = [],
            this._items = {},
    ...
    class wi extends t.cat.views.recharge.RechargeCellViewUI {
        dataChanged(t) {
            var e = this.dataSource;
            e && (this.m_img_Icon.skin = `cat/ui_recharge/fc${e.iconId}.png`,
            this.m_img_Double.visible = e.showDouble,
            this.m_txt_Price.text = "$ " + e.price,
            this.m_txt_FishNum.text = v(1023, e.amount),
            this.m_txt_DoubleNum.text = "+" + e.amount,
            this.m_img_Extra.visible = !e.showDouble && 0 < +e.extra,
            this.m_txt_ExtraFish.text = "+" + e.extra)
        }
    }
    class Si extends t.cat.views.squad.BoostCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
    ...
    class xi extends t.cat.views.squad.FriendInviteCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
    ...
    class Li extends t.cat.views.squad.SquadCellViewUI {
        dataChanged(t, e) {
            e ? this.dataSource = e : e = this.dataSource,
            this.m_txt_Level.text = v(Ft[e.league]),
            this.m_txt_Name.text = e.name,
    ...
    class P {
        ...
        static init() {
            ...
            t("logic/views/common/CountView.ts", _i),
            t("logic/views/common/FishCoinView.ts", ui),
            t("logic/views/common/LoadingView", A),
            t("logic/views/common/LvView.ts", gi),
            t("logic/views/common/WifiView.ts", ai),
            t("logic/views/fish/FishHistoryCellView.ts", re),
            t("logic/views/fish/FishItemView.ts", fe),
            t("logic/views/fish/FishRankCellView.ts", pi),
            t("logic/views/squad/HeadView.ts", Ci),
            t("logic/views/fish/FishRewardDetailCellView.ts", yi),
            t("logic/views/home/SumCatView.ts", vi),
            t("logic/views/home/ShopCellView.ts", fi),
            t("logic/views/lunchPool/AssetCellView.ts", bi),
            t("logic/views/lunchPool/LunchCellView.ts", Ze),
            t("logic/base/ui/SuperStack.ts", ki),
            t("logic/views/recharge/RechargeCellView.ts", wi),
            t("logic/views/squad/BoostCellView.ts", Si),
            t("logic/views/squad/FriendCellView.ts", Pe),
            t("logic/views/squad/FriendInviteCellView.ts", xi),
            t("logic/views/squad/SquadCellView.ts", Li),
            t("logic/views/squad/RankCellView.ts", Re)
        }
    }
    P.width = 560,
    P.height = 1120,
